...
## -*- texinfo -*-
## @deftypefn {} {} configureTerminator (@var{tcp}, @var{term})
## @deftypefnx {} {} configureTerminator (@var{tcp}, @var{readterm}, @var{writeterm})
...
function configureTerminator (tcp, readterm, writeterm)
  ...
  elseif nargin == 2
    __tcpserver_properties__ (tcp, 'terminator', readterm);
  elseif nargin == 3
    __tcpserver_properties__ (tcp, 'terminator', readterm, writeterm);
  else
