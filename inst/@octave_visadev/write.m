...
## @deftypefnx {} {@var{numbytes} =} write (@var{obj}, @var{data}, @var{precision})
## Writes @var{data} to visadev instrument
##
## @subsubheading Inputs
## @var{obj} is a visadev object.@*
...
function numbytes = write(obj, data, precision)
