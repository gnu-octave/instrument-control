...
## @deftypefnx {} {@var{numbytes} = } write (@var{obj}, @var{data}, @var{destinationAddress}, @var{destinationPort}))
## @deftypefnx {} {@var{numbytes} =} write (@var{obj}, @var{data}, @var{datatype})
## @deftypefnx {} {@var{numbytes} =} write (@var{obj}, @var{data}, @var{datatype}, @var{destinationAddress}, @var{destinationPort})
...
function numbytes = write(obj, data, varargin)
  ...
  datatype = "uint8";
  destinationAddress = obj.remotehost;
  destinationPort = obj.remoteport;
  ...
  oldaddr = obj.remotehost;
  oldport = obj.remoteport;
  try
    obj.remotehost = destinationAddress;
    obj.remoteport = destinationPort;
  catch
    obj.remotehost = oldaddr;
    obj.remoteport = oldport;
    rethrow (lasterror)
  end_try_catch
