...
class octave_tcpserver : public octave_base_value
{
public:
  octave_tcpserver (void);
  ~octave_tcpserver (void);
  ...
  int check_for_connections ();

  // Overloaded base functions
  double tcpserver_value (void) const { return (double)fd; }
  ...
  */
  ...
  std::string get_client_address (void) const;
  int get_client_port (void) const;

  bool is_open(void) const;

  bool get_connected (void) const;

  std::string get_type (void) const { return "tcpserver"; }
