...
<dt class="deftypefn def-line" id="index-serial"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">serial</var> =</code> <strong class="def-name">serial</strong> <code class="def-code-arguments">([<var class="var">path</var>], [<var class="var">baudrate</var>], [<var class="var">timeout</var>])</code><a class="copiable-link" href="#index-serial"></a></span></dt>
<dd> 
