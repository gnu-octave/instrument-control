...
<dt class="deftypefn" id="index-i2c"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">i2c</var> =</code> <strong class="def-name">i2c</strong> <code class="def-code-arguments">([<var class="var">port_path</var>], [<var class="var">address</var>])</code><a class="copiable-link" href="#index-i2c"></a></span></dt>
<dd> 
