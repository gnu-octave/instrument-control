...
<dt class="deftypefn def-line" id="index-instrhwinfo"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">list</var>] =</code> <strong class="def-name">instrhwinfo</strong> <code class="def-code-arguments">()</code><a class="copiable-link" href="#index-instrhwinfo"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-instrhwinfo-1"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">list</var> =</code> <strong class="def-name">instrhwinfo</strong> <code class="def-code-arguments">(<var class="var">interface</var>)</code><a class="copiable-link" href="#index-instrhwinfo-1"></a></span></dt>
