...
<dt class="deftypefn def-line" id="index-gpib_005fread"><span class="category-def">Loadable Function: </span><span><code class="def-type">[<var class="var">data</var>, <var class="var">count</var>, <var class="var">eoi</var>] =</code> <strong class="def-name">gpib_read</strong> <code class="def-code-arguments">(<var class="var">gpib</var>, <var class="var">n</var>)</code><a class="copiable-link" href="#index-gpib_005fread"></a></span></dt>
<dd> 
