...
<dt class="deftypefn def-line" id="index-configureTerminator"><span class="category-def">Function File: </span><span><strong class="def-name">configureTerminator</strong> <code class="def-code-arguments">(<var class="var">serial</var>, <var class="var">term</var>)</code><a class="copiable-link" href="#index-configureTerminator"></a></span></dt>
