...
<dt class="deftypefn" id="index-writebinblock"><span class="category-def">: </span><span><strong class="def-name">writebinblock</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">data</var>, <var class="var">datatype</var>)</code><a class="copiable-link" href="#index-writebinblock"></a></span></dt>
