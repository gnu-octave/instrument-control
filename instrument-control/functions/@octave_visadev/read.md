---
layout: "default"
permalink: "/functions/@octave_visadev/20_octavevisadevread/"
...
title: "Instrument-control Toolkit - @octave_visadev/read"
category: "VXI11"
func_name: "@octave_visadev/read"
navigation:
- id: "overview"
  name: "Overview"
  url: "/index"
...
<dt class="deftypefn def-line" id="index-read"><span class="category-def">: </span><span><code class="def-type"><var class="var">data</var> =</code> <strong class="def-name">read</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">count</var>)</code><a class="copiable-link" href="#index-read"></a></span></dt>
