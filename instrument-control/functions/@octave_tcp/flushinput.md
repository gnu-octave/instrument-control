...
<dt class="deftypefn def-line" id="index-flushinput"><span class="category-def">Loadable Function: </span><span><strong class="def-name">flushinput</strong> <code class="def-code-arguments">(<var class="var">tcp</var>)</code><a class="copiable-link" href="#index-flushinput"></a></span></dt>
<dd>
