...
<dt class="deftypefn def-line" id="index-srl_005ftimeout"><span class="category-def">Loadable Function: </span><span><strong class="def-name">srl_timeout</strong> <code class="def-code-arguments">(<var class="var">serial</var>, <var class="var">timeout</var>)</code><a class="copiable-link" href="#index-srl_005ftimeout"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-srl_005ftimeout-1"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">t</var> =</code> <strong class="def-name">srl_timeout</strong> <code class="def-code-arguments">(<var class="var">serial</var>)</code><a class="copiable-link" href="#index-srl_005ftimeout-1"></a></span></dt>
<dd>
