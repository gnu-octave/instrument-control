...
<dt class="deftypefn def-line" id="index-srl_005fparity"><span class="category-def">Loadable Function: </span><span><strong class="def-name">srl_parity</strong> <code class="def-code-arguments">(<var class="var">serial</var>, <var class="var">parity</var>)</code><a class="copiable-link" href="#index-srl_005fparity"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-srl_005fparity-1"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">p</var> =</code> <strong class="def-name">srl_parity</strong> <code class="def-code-arguments">(<var class="var">serial</var>)</code><a class="copiable-link" href="#index-srl_005fparity-1"></a></span></dt>
<dd>
