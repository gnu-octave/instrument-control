...
<dt class="deftypefn def-line" id="index-write"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">numbytes</var> =</code> <strong class="def-name">write</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">data</var>)</code><a class="copiable-link" href="#index-write"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-write-1"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">numbytes</var> =</code> <strong class="def-name">write</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">data</var>, <var class="var">destinationAddress</var>, <var class="var">destinationPort</var>))</code><a class="copiable-link" href="#index-write-1"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-write-2"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">numbytes</var> =</code> <strong class="def-name">write</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">data</var>, <var class="var">datatype</var>)</code><a class="copiable-link" href="#index-write-2"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-write-3"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">numbytes</var> =</code> <strong class="def-name">write</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">data</var>, <var class="var">datatype</var>, <var class="var">destinationAddress</var>, <var class="var">destinationPort</var>)</code><a class="copiable-link" href="#index-write-3"></a></span></dt>
