...
<dt class="deftypefn def-line" id="index-writeline"><span class="category-def">: </span><span><strong class="def-name">writeline</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">data</var>)</code><a class="copiable-link" href="#index-writeline"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-writeline-1"><span class="category-def">: </span><span><strong class="def-name">writeline</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">data</var>, <var class="var">destaddr</var>, <var class="var">destport</var>)</code><a class="copiable-link" href="#index-writeline-1"></a></span></dt>
